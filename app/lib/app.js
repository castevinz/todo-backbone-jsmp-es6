...
// Const currently disabled due to compiler, but would otherwise be written:
...
class TodoList extends Collection {
  ...
  constructor(options) {
    ...
    this.localStorage = new LocalStorage('backbone-jspm-es6');
  }
